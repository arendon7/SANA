(() => {
  ...
  const actionPolicy={
    admin:['*'],
    technical:['guided-checkpoint','fieldRecord','quickField','task-toggle','plan-activity','activity-evidence','activity-close','cycle-close-review','economics-cost','economics-scenario','phenology','nutrition','health','inventory','inventory-movement','team-worklog','material','material-lifecycle-event','sensor','visit','structured-visit','agronomist-case','input-forecast-adjustment','plan','plan-review','harvest-result','circularity-residue','report','reportOpen','report-snapshot','dd-remediation','document-source-link','methodology','impact-methodology','impact-methodology-review','knowledge','exportPassport','queue-review'],
    producer:['guided-checkpoint','fieldRecord','quickField','task-toggle','plan-activity','activity-evidence','activity-close','cycle-close-review','economics-cost','economics-scenario','phenology','nutrition','health','inventory','inventory-movement','team-worklog','material-lifecycle-event','structured-visit','agronomist-case','input-forecast-adjustment','harvest-result','circularity-residue','report-snapshot','dd-remediation','document-source-link','methodology','reportOpen','exportPassport','queue-review','characterization:*','capital-dossier'],
  ...
  const selectorActions=[['[data-guide-complete]','guided-checkpoint'],['[data-task]','task-toggle'],['[data-queue]','queue-review'],['[data-field-quick]','quickField'],['[data-workflow-create]','plan-activity'],['[data-workflow-evidence]','activity-evidence'],['[data-workflow-close]','activity-close'],['[data-cycle-review]','cycle-close-review'],['[data-econ-cost]','economics-cost'],['[data-econ-scenario]','economics-scenario'],['[data-impact-review]','impact-methodology-review'],['[data-character-section]','characterization:*'],['[data-material-event]','material-lifecycle-event'],['[data-plan-review]','plan-review'],['[data-plan-transition]','plan-review'],['[data-structured-visit]','structured-visit'],['[data-agronomist-case]','agronomist-case'],['[data-forecast-adjust]','input-forecast-adjustment'],['[data-inventory-movement]','inventory-movement'],['[data-team-worklog]','team-worklog'],['[data-report-snapshot]','report-snapshot'],['[data-dd-remediation]','dd-remediation'],['[data-document-source]','document-source-link'],['[data-harvest-result]','harvest-result'],['[data-circularity-residue]','circularity-residue'],['[data-capital-config]','capital-dossier'],['[data-impact-methodology]','impact-methodology']];
