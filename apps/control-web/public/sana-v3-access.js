(() => {
  ...
  const actionPolicy={
    admin:['*'],
    technical:['guided-checkpoint','fieldRecord','quickField','task-toggle','plan-activity','activity-evidence','activity-close','cycle-close-review','economics-cost','economics-scenario','phenology','nutrition','health','inventory','inventory-movement','team-worklog','material','material-lifecycle-event','sensor','visit','structured-visit','agronomist-case','input-forecast-adjustment','plan','plan-review','harvest-result','circularity-residue','report','reportOpen','report-snapshot','document-source-link','methodology','impact-methodology','knowledge','exportPassport','queue-review'],
