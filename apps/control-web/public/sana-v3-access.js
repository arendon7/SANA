(() => {
  ...
  const actionPolicy={
    admin:['*'],
    technical:['fieldRecord','quickField','task-toggle','phenology','nutrition','health','inventory','material','sensor','visit','structured-visit','agronomist-case','input-forecast-adjustment','plan','plan-review','harvest-result','circularity-residue','report','reportOpen','report-snapshot','methodology','impact-methodology','knowledge','exportPassport','queue-review'],
    producer:['fieldRecord','quickField','task-toggle','phenology','nutrition','health','inventory','structured-visit','agronomist-case','input-forecast-adjustment','harvest-result','circularity-residue','cost','report-snapshot','methodology','reportOpen','exportPassport','queue-review','characterization:*','capital-dossier'],
