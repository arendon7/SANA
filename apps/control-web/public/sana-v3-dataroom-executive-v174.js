(() => {
  ...
  const INSPECTED_CONTRACTS=Object.freeze([
    ...
    Object.freeze({id:'SOURCE_EVIDENCE_HISTORY',file:'sana-v3-dataroom-source-evidence-history.js',globalName:'__SANA_DATAROOM_SOURCE_EVIDENCE_HISTORY__',schema:'SANA_DUE_DILIGENCE_SNAPSHOT_V1',claimSpecificLink:'NOT_MATERIALIZED',observedReferenceKeys:Object.freeze(['snapshotRef','evidenceRef'])}),
    Object.freeze({id:'IMPACT_HISTORY',file:'sana-v3-dataroom-impact-history.js',globalName:'__SANA_DATAROOM_IMPACT_HISTORY__',schema:'SANA_DUE_DILIGENCE_SNAPSHOT_V1',claimSpecificLink:'NOT_MATERIALIZED',observedReferenceKeys:Object.freeze(['snapshotRef','entityRef'])})
  ]);
