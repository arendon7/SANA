(() => {
  ...
  function compare(baseSnapshot,targetSnapshot){
    ...
    compareKeyed(changes,'Economía',a.economics,b.economics,'lotId',[
      ...
      {key:'explicitCostCount',label:'Costos explícitos vinculados',kind:'PROCEDENCIA'},
      {key:'supportedExplicitCount',label:'Costos explícitos con soporte',kind:'PROCEDENCIA'},
      {key:'supportCoverage',label:'Cobertura de soporte %',kind:'PROCEDENCIA'},
      {key:'mismatchCount',label:'Vínculos económicos inconsistentes',kind:'PROCEDENCIA'},
      {key:'unallocatedCount',label:'Costos no asignados a ciclo',kind:'PROCEDENCIA'},
      {key:'provenanceGranularity',label:'Granularidad de procedencia',kind:'PROCEDENCIA'}
    ]);
