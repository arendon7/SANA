(() => {
  ...
  function injectReviewContextSummary(html){
    ...
    out=out.replace('DATA ROOM · REVIEW WORKSPACE V101','DATA ROOM · REVIEW WORKSPACE V115').replace('Circuito de revisión, con navegación bidireccional al caso fuente','Circuito de revisión, con retorno técnico a integridad');
