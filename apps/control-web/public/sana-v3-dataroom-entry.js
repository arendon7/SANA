(() => {
  ...
  function reviewContextRecoveryHtml(actions=[]){
  ...
  function injectReviewContextSummary(html){
    ...
    out=out.replace('DATA ROOM · REVIEW WORKSPACE V101','DATA ROOM · REVIEW WORKSPACE V110').replace('Circuito de revisión, con navegación bidireccional al caso fuente','Circuito de revisión, con recuperación URL y continuidad de foco');
