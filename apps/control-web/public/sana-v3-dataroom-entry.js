(() => {
  ...
  function injectReviewContextSummary(html){
    ...
    out=out.replace('DATA ROOM · REVIEW WORKSPACE V101','DATA ROOM · REVIEW WORKSPACE V111').replace('Circuito de revisión, con navegación bidireccional al caso fuente','Circuito de revisión, con vista previa y recuperación URL');
