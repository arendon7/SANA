(() => {
  ...
  function injectReviewContextSummary(html){
    ...
    out=out.replace('DATA ROOM · REVIEW WORKSPACE V101','DATA ROOM · REVIEW WORKSPACE V116').replace('Circuito de revisión, con navegación bidireccional al caso fuente','Circuito de revisión, con ayuda humana bajo divulgación progresiva');
