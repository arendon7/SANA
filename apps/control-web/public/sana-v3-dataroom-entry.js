(() => {
  ...
  function reviewStructuralDiagnosticsIndex(integrity){
    const sources=Array.isArray(integrity?.sources)?integrity.sources:[];
  ...
  function injectReviewContextSummary(html){
    ...
    out=out.replace('DATA ROOM · REVIEW WORKSPACE V101','DATA ROOM · REVIEW WORKSPACE V120').replace('Circuito de revisión, con navegación bidireccional al caso fuente','Circuito de revisión, con índice de diagnósticos estructurales');
  ...
  if(typeof document!=='undefined'){
    document.addEventListener('click',e=>{
      ...
      const structuralIndex=e.target.closest?.('[data-review-structural-index-nav]');
