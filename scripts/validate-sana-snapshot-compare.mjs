...
assert.equal(legacyResult.total,0,'two legacy V1 snapshots must not invent provenance deltas');
...
console.log(`snapshot compare contract OK · ${result.total} synthetic changes · additive V1 economic provenance covered`);
