...
const meta={Q1:'H1',L1:'Q1',D1:'H1',S1:'D1',E1:'',QMISS:'NOPE',QKIND:'D1',QCROSS:'H2',QFWD:'HF',SEMPTY:''};
...
assert.equal(c.total,11);assert.equal(c.linked,6);assert.equal(c.issues,5);
