...
assert(!/%|score|severidad|prioridad técnica/i.test(rendered.slice(rendered.indexOf('data-review-source-overview'),rendered.indexOf('review-technical-glossary'))));
