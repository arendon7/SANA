...
try:
    ...
    with sync_playwright() as p:
        ...
        for label,viewport in [('desktop',{'width':1440,'height':1000}),('mobile',{'width':390,'height':844})]:
            ...
            for token in ['OIDC Production Session Adapter','PASS_REVIEW','PENDING_PRODUCTION','ProductionSession','AUTHORIZED_FOR_ADAPTER','RS256 / ES256','PRODUCTION_IDENTITY_PROVIDER_CONFIGURATION_PENDING','HUMAN_ONLY','ADVISORY_ONLY','D10=PENDING']:check(f'{label}:token:{token}',token in body)
